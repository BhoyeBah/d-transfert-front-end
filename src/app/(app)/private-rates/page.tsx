...
export default async function PrivateRatesPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        title="Taux d'envoi"
        description="Votre taux d'envoi privé, par devise — jamais visible par vos collaborateurs. Défini une seule fois, il s'applique automatiquement à tous les envois dans cette devise, quel que soit le collaborateur, et vous pouvez le changer à tout moment."
